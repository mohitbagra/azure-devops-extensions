...
export const getTeamTemplates = createSelector(
    getTeamTemplatesState,
    (state: ITeamTemplates | undefined) => state && state.templates
);
...
export const getTeamTemplatesError = createSelector(
    getTeamTemplatesState,
    (state: ITeamTemplates | undefined) => state && state.error
);
...
export const getTemplate = createSelector(
    getTemplateState,
    (state: IWorkItemTemplate | undefined) => state && state.template
);
...
export const getTemplateError = createSelector(
    getTemplateState,
    (state: IWorkItemTemplate | undefined) => state && state.error
);
