...
export const getGitRepos = createSelector(getGitRepoState, (state: IGitRepoState | undefined) => state && state.gitRepos);

export const getGitReposMap = createSelector(getGitRepoState, (state: IGitRepoState | undefined) => state && state.gitReposMap);
...
export const getGitReposError = createSelector(getGitRepoState, (state: IGitRepoState | undefined) => state && state.error);
