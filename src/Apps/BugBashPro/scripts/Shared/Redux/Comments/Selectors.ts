...
export const getComments = createSelector(getCommentsStateModel, (state) => state && state.comments);

export const getCommentsStatus = createSelector(getCommentsStateModel, (state) => (state && state.status) || LoadStatus.NotLoaded);

export const getCommentsError = createSelector(getCommentsStateModel, (state) => state && state.error);
