...
export const getAllBugBashes = createSelector(getBugBashesState, (state) => state && state.bugBashes);

export const getBugBashesStatus = createSelector(getBugBashesState, (state) => (state && state.status) || LoadStatus.NotLoaded);

export const getBugBash = createSelector(getBugBashStateModel, (bugBashStateModel) => {
    return bugBashStateModel && bugBashStateModel.bugBash;
});

export const getBugBashStatus = createSelector(getBugBashStateModel, (bugBashStateModel) => {
    return (bugBashStateModel && bugBashStateModel.status) || LoadStatus.NotLoaded;
});

export const getBugBashError = createSelector(getBugBashStateModel, (bugBashStateModel) => {
