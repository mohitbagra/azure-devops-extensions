...
export const areSettignsInitialized = createSelector(
    getChecklistSettingsState,
    state => !!(state && state.initialized)
);

export const isWordWrapOn = createSelector(
    getChecklistSettingsState,
    state => !!(state && state.wordWrap)
);

export const isHideCompletedItemsOn = createSelector(
    getChecklistSettingsState,
